...
export default function System_schema() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/GetTables?keySpace=system_distributed')
            .then(
                (result) => {
                    setIsLoaded(true);
    ...
    useEffect(() => {
        fetch('http://localhost:8080/GetTables?keySpace=system_distributed')
        ...
        <div className="App">
            ...
            <div className="row">
                <div className="content" role="main">
                    ...
                    <div className="ag-theme-balham-dark" style={{ width: 1605, height: 500 }}>
                        <AgGridReact
