...
export default function System_traces() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/GetTables?keySpace=system_traces')
            .then(
                (result) => {
                    setIsLoaded(true);
    ...
    useEffect(() => {
        fetch('http://localhost:8080/GetTables?keySpace=system_traces')
